    ...
    <footer className="mt-24 border-t border-border bg-cocoa text-cream/90">
      <div className="mx-auto grid max-w-7xl gap-10 px-4 py-14 md:grid-cols-4 md:px-8">
        <div className="md:col-span-2">
          <div className="flex items-center gap-3">
            <img src={logo} alt="NATURAL RECIPE PRODUCTS" className="h-12 w-12 object-contain" width={48} height={48} />
            <span className="font-serif text-2xl font-semibold text-cream">NATURAL RECIPE PRODUCTS</span>
          </div>
      ...
      <div className="border-t border-cream/10">
        <div className="mx-auto max-w-7xl px-4 py-6 text-center text-xs text-cream/60 md:px-8">
          © {new Date().getFullYear()} NATURAL RECIPE PRODUCTS. Crafted with care from Andhra.
        </div>
      </div>
    </footer>
  );
