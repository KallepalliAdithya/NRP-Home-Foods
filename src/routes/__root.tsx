...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "NATURAL RECIPE PRODUCTS" },
      { property: "og:site_name", content: "NATURAL RECIPE PRODUCTS" },
      ...
      { name: "twitter:title", content: "NATURAL RECIPE PRODUCTS — Taste of Andhra, Away From Home" },
